...
public class GetIngredientsService extends IntentService {
    ...
    public static final String ACTION_GET_INGREDIENTS = "baking.example.android.bakingapp.action.GET_INGREDIENTS";

    public static final String EXTRA_RECIPE_ID = "baking.example.android.bakingapp.extra.RECIPE_ID";;
